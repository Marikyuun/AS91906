...
class Question:
    def __init__(self,parent):
        ...
        print("The amount of remaining questions is: "+str(len(questions))+" and the amount of remaining answers is: "+str(len(answers)))
        print(questions)
        print(answers)
        ...
        self.question_heading = Label(self.question_frame, text = "Question "+str(len(question_number)),
                                      font = "calibri 14 bold", bg = background_color, padx = 100, pady = 20, borderwidth = 5, relief = "solid")
        self.question_heading.grid(row = 0)        
        
        # Question (row 1)
        self.question_label = Label(self.question_frame,
                                         text = questions[question_index],
                                         font = "calibri 12 bold", wrap = 290,
                                         bg = "pale green",
                                         padx = 100, pady = 20)
